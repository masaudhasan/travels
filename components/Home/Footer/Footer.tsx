    ...
    <div className='pt-16 pb-16'>
        <div className='w-[80%] mx-auto grid items-start grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10'>
            ...
            <div>
                ...
                <div className='mt-6'>
                    ...
                    <h1 className='text-base font-bold text-gray-950 mt-1'>+012 345 6788</h1>
                </div>
                <div className='mt-6'>
                    <h1 className='text-sm text-gray-600'>Our Mobile Email</h1>
                    <h1 className='text-base font-bold text-gray-950 mt-1'>example@gmail.com</h1>
                </div>
            </div>
        </div>
        {/* bottom section */}
        <div className='mt-8 w-[80%] mx-auto border-t pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm'>
            ...
            <div className='flex items-center space-x-4 mt-4 md:mt-0 '>
                ...
                <a href="#" className='text-gray-500 hover:text-gray-800'><FaDribbble/></a>
            </div>
        </div>
    </div>
  )
